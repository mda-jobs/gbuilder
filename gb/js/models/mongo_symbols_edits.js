...
["createRole", "Creates a role and specifies its privileges.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/createRole/#dbcmd.createRole"]]],

["dropAllRolesFromDatabase", "Deletes all user-defined roles from a databasehttps://docs.mongodb.org/manual/reference/command/dropAllRolesFromDatabase/#dbcmd.dropAllRolesFromDatabase

["dropRole", "Deletes the user-defined role.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/dropRole/#dbcmd.dropRole"]]],

["grantPrivilegesToRole", "Assigns privileges to a user-defined role.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/grantPrivilegesToRole/#dbcmd.grantPrivilegesToRole"]]],

["grantRolesToRole", "Specifies roles from which a user-defined role inherits privileges.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/grantRolesToRole/#dbcmd.grantRolesToRole"]]],

["invalidateUserCache", "Flushes the in-memory cache of user information, including credentials and roles.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/invalidateUserCache/#dbcmd.invalidateUserCache"]]],

["revokePrivilegesFromRole", "Removes the specified privileges from a user-defined role.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/revokePrivilegesFromRole/#dbcmd.revokePrivilegesFromRole"]]],

["revokeRolesFromRole", "Removes specified inherited roles from a user-defined role.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/revokeRolesFromRole/#dbcmd.revokeRolesFromRole"]]],
...
["applyOps", "Internal command that applies oplog entries to the current data set.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/applyOps/#dbcmd.applyOps"]]],

["isMaster", "Displays information about this member’s role in the replica set, including whether it is the master.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/isMaster/#dbcmd.isMaster"]]],

["replSetFreeze", "Prevents the current member from seeking election as primary for a period of time.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/replSetFreeze/#dbcmd.replSetFreeze"]]],

["replSetGetStatus", "Returns a document that reports on the status of the replica set.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/replSetGetStatus/#dbcmd.replSetGetStatus"]]],

["replSetInitiate", "Initializes a new replica set.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/replSetInitiate/#dbcmd.replSetInitiate"]]],

["replSetMaintenance", "Enables or disables a maintenance mode, which puts a secondary node in a RECOVERING state.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/replSetMaintenance/#dbcmd.replSetMaintenance"]]],

["replSetReconfig", "Applies a new configuration to an existing replica set.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/replSetReconfig/#dbcmd.replSetReconfig"]]],
...
["_migrateClone", "Internal command that supports chunk migration. Do not call directly.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/migrateClone/#dbcmd._migrateClone"]]],

["_recvChunkAbort", "Internal command that supports chunk migrations in sharded clusters. Do not call directly.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/recvChunkAbort/#dbcmd._recvChunkAbort"]]],

["_recvChunkCommit", "Internal command that supports chunk migrations in sharded clusters. Do not call directly.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/recvChunkCommit/#dbcmd._recvChunkCommit"]]],

["_recvChunkStart", "Internal command that facilitates chunk migrations in sharded clusters.. Do not call directly.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/recvChunkStart/#dbcmd._recvChunkStart"]]],

["_recvChunkStatus", "Internal command that returns data to support chunk migrations in sharded clusters. Do not call directly.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/recvChunkStatus/#dbcmd._recvChunkStatus"]]],

["_replSetFresh", "Internal command that supports replica set election operations.", [["", "", ""]]],

["_transferMods", "Internal command that supports chunk migrations. Do not call directly.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/transferMods/#dbcmd._transferMods"]]],

["handshake", "Internal command.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/handshake/#dbcmd.handshake"]]],

["mapreduce.shardedfinish", "Internal command that supports map-reduce in sharded cluster environments.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/mapreduce.shardedfinish/#dbcmd.mapreduce.shardedfinish"]]],

["replSetElect", "Internal command that supports replica set functionality.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/replSetElect/#dbcmd.replSetElect"]]],

["replSetGetRBID", "Internal command that supports replica set operations.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/replSetGetRBID/#dbcmd.replSetGetRBID"]]],

["replSetHeartbeat", "Internal command that supports replica set operations.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/replSetHeartbeat/#dbcmd.replSetHeartbeat"]]],

["writebacklisten", "Internal command that supports chunk migrations in sharded clusters.", [["MongoDB", "Database Commands", "https://docs.mongodb.org/manual/reference/command/writebacklisten/#dbcmd.writebacklisten"]]],
...
["Bulk()", "Bulk operations builder.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk/#Bulk"]]],

["db.collection.initializeOrderedBulkOp()", "Initializes a Bulk() operations builder for an ordered list of operations.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.initializeUnorderedBulkOp/#db.collection.initializeUnorderedBulkOp"]]],

["db.collection.initializeUnorderedBulkOp()", "Initializes a Bulk() operations builder for an unordered list of operations.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.initializeUnorderedBulkOp/#db.collection.initializeUnorderedBulkOp"]]],

["Bulk.insert()", "Adds an insert operation to a list of operations.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.insert/#Bulk.insert"]]],

["Bulk.find()", "Specifies the query condition for an update or a remove operation.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.find/#Bulk.find"]]],

["Bulk.find.removeOne()", "Adds a single document remove operation to a list of operations.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.find.removeOne/#Bulk.find.removeOne"]]],

["Bulk.find.remove()", "Adds a multiple document remove operation to a list of operations.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.find.remove/#Bulk.find.remove"]]],

["Bulk.find.replaceOne()", "Adds a single document replacement operation to a list of operations.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.find.replaceOne/#Bulk.find.replaceOne"]]],

["Bulk.find.updateOne()", "Adds a single document update operation to a list of operations.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.find.updateOne/#Bulk.find.updateOne"]]],

["Bulk.find.update()", "Adds a multi update operation to a list of operations.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.find.update/#Bulk.find.update"]]],

["Bulk.find.upsert()", "Specifies upsert: true for an update operation.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.find.upsert/#Bulk.find.upsert"]]],

["Bulk.execute()", "Executes a list of operations in bulk.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.execute/#Bulk.execute"]]],

["Bulk.getOperations()", "Returns an array of write operations executed in the Bulk() operations object.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.getOperations/#Bulk.getOperations"]]],

["Bulk.tojson()", "Returns a JSON document that contains the number of operations and batches in the Bulk() operations object.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.tojson/#Bulk.tojson"]]],

["Bulk.toString()", "Returns the Bulk.tojson() results as a string.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Bulk.toString/#Bulk.toString"]]]

["db.collection.aggregate()", "Provides access to the aggregation pipeline.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.aggregate/#db.collection.aggregate"]]],

["db.collection.bulkWrite()", "Provides bulk write operation functionality.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.bulkWrite/#db.collection.bulkWrite"]]],

["db.collection.count()", "Wraps count to return a count of the number of documents in a collection or matching a query.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.count/#db.collection.count"]]],

["db.collection.copyTo()", "Deprecated. Wraps eval to copy data between collections in a single MongoDB instance.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.copyTo/#db.collection.copyTo"]]],

["db.collection.createIndex()", "Builds an index on a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.createIndex/#db.collection.createIndex"]]],

["db.collection.dataSize()", "Returns the size of the collection. Wraps the size field in the output of the collStats.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.dataSize/#db.collection.dataSize"]]],

["db.collection.deleteOne()", "Deletes a single document in a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.deleteOne/#db.collection.deleteOne"]]],

["db.collection.deleteMany()", "Deletes multiple documents in a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.deleteMany/#db.collection.deleteMany"]]],

["db.collection.distinct()", "Returns an array of documents that have distinct values for the specified field.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.distinct/#db.collection.distinct"]]],

["db.collection.drop()", "Removes the specified collection from the database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.drop/#db.collection.drop"]]],

["db.collection.dropIndex()", "Removes a specified index on a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.dropIndex/#db.collection.dropIndex"]]],

["db.collection.dropIndexes()", "Removes all indexes on a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.dropIndexes/#db.collection.dropIndexes"]]],

["db.collection.ensureIndex()", "Deprecated. Use db.collection.createIndex().", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.ensureIndex/#db.collection.ensureIndex"]]],

["db.collection.explain()", "Returns information on the query execution of various methods.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.explain/#db.collection.explain"]]],

["db.collection.find()", "Performs a query on a collection and returns a cursor object.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.find/#db.collection.find"]]],

["db.collection.findAndModify()", "Atomically modifies and returns a single document.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.findAndModify/#db.collection.findAndModify"]]],

["db.collection.findOne()", "Performs a query and returns a single document.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.findOne/#db.collection.findOne"]]],

["db.collection.findOneAndDelete()", "Finds a single document and deletes it.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.findOneAndDelete/#db.collection.findOneAndDelete"]]],

["db.collection.findOneAndReplace()", "Finds a single document and replaces it.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.findOneAndReplace/#db.collection.findOneAndReplace"]]],

["db.collection.findOneAndUpdate()", "Finds a single document and updates it.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.findOneAndUpdate/#db.collection.findOneAndUpdate"]]],

["db.collection.getIndexes()", "Returns an array of documents that describe the existing indexes on a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.getIndexes/#db.collection.getIndexes"]]],

["db.collection.getShardDistribution()", "For collections in sharded clusters, <a href='https://docs.mongodb.org/manual/reference/method/db.collection.getShardDistribution/#db.collection.getShardDistribution'>db.collection.getShardDistribution()</a> reports data of chunk distribution.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.getShardDistribution/#db.collection.getShardDistribution"]]],

["db.collection.getShardVersion()", "Internal diagnostic method for shard cluster.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.getShardVersion/#db.collection.getShardVersion"]]],

["db.collection.group()", "Provides simple data aggregation function. Groups documents in a collection by a key, and processes the results. Use aggregate() for more complex data aggregation.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.group/#db.collection.group"]]],

["db.collection.insert()", "Creates a new document in a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.insert/#db.collection.insert"]]],

["db.collection.insertOne()", "Inserts a new document in a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.insertOne/#db.collection.insertOne"]]],

["db.collection.insertMany()", "Inserts several new document in a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.insertMany/#db.collection.insertMany"]]],

["db.collection.isCapped()", "Reports if a collection is a capped collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.isCapped/#db.collection.isCapped"]]],

["db.collection.mapReduce()", "Performs map-reduce style data aggregation.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.mapReduce/#db.collection.mapReduce"]]],

["db.collection.reIndex()", "Rebuilds all existing indexes on a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.reIndex/#db.collection.reIndex"]]],

["db.collection.replaceOne()", "Replaces a single document in a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.replaceOne/#db.collection.replaceOne"]]],

["db.collection.remove()", "Deletes documents from a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.remove/#db.collection.remove"]]],

["db.collection.renameCollection()", "Changes the name of a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.renameCollection/#db.collection.renameCollection"]]],

["db.collection.save()", "Provides a wrapper around an insert() and update() to insert new documents.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.save/#db.collection.save"]]],

["db.collection.stats()", "Reports on the state of a collection. Provides a wrapper around the collStats.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.stats/#db.collection.stats"]]],

["db.collection.storageSize()", "Reports the total size used by the collection in bytes. Provides a wrapper around the storageSize field of the collStats output.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.storageSize/#db.collection.storageSize"]]],

["db.collection.totalSize()", "Reports the total size of a collection, including the size of all documents and all indexes on a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.totalSize/#db.collection.totalSize"]]],

["db.collection.totalIndexSize()", "Reports the total size used by the indexes on a collection. Provides a wrapper around the totalIndexSize field of the collStats output.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.totalIndexSize/#db.collection.totalIndexSize"]]],

["db.collection.update()", "Modifies a document in a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.update/#db.collection.update"]]],

["db.collection.updateOne()", "Modifies a single document in a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.updateOne/#db.collection.updateOne"]]],

["db.collection.updateMany()", "Modifies multiple documents in a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.collection.updateMany/#db.collection.updateMany"]]],
...
["Mongo.getDB()", "Returns a database object.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Mongo.getDB/#Mongo.getDB"]]],

["Mongo.getReadPrefMode()", "Returns the current read preference mode for the MongoDB connection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Mongo.getReadPrefMode/#Mongo.getReadPrefMode"]]],

["Mongo.getReadPrefTagSet()", "Returns the read preference tag set for the MongoDB connection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Mongo.getReadPrefTagSet/#Mongo.getReadPrefTagSet"]]],

["Mongo.setReadPref()", "Sets the read preference for the MongoDB connection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Mongo.setReadPref/#Mongo.setReadPref"]]],

["Mongo.setSlaveOk()", "Allows operations on the current connection to read from secondary members.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Mongo.setSlaveOk/#Mongo.setSlaveOk"]]],

["Mongo()", "Creates a new connection object.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Mongo/#Mongo"]]],
...
["Date()", "Creates a date object. By default creates a date object including the current date.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/Date/#Date"]]],

["UUID()", "Converts a 32-byte hexadecimal string to the UUID BSON subtype.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/UUID/#UUID"]]],

["ObjectId.getTimestamp()", "Returns the timestamp portion of an ObjectId.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/ObjectId.getTimestamp/#ObjectId.getTimestamp"]]],

["ObjectId.toString()", "Displays the string representation of an ObjectId.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/ObjectId.toString/#ObjectId.toString"]]],

["ObjectId.valueOf()", "Displays the str attribute of an ObjectId as a hexadecimal string.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/ObjectId.valueOf/#ObjectId.valueOf"]]],

["WriteResult()", "Wrapper around the result set from write methods.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/WriteResult/#WriteResult"]]],

["WriteResult.hasWriteError()", "Returns a boolean specifying whether the results include WriteResult.writeError.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/WriteResult.hasWriteError/#WriteResult.hasWriteError"]]],

["WriteResult.hasWriteConcernError()", "Returns a boolean specifying whether whether the results include WriteResult.writeConcernError.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/WriteResult.hasWriteConcernError/#WriteResult.hasWriteConcernError"]]],

["BulkWriteResult()", "Wrapper around the result set from Bulk.execute().", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/BulkWriteResult/#BulkWriteResult"]]]

["cursor.batchSize()", "Controls the number of documents MongoDB will return to the client in a single network message.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.batchSize/#cursor.batchSize"]]],

["cursor.close()", "Close a cursor and free associated server resources.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.close/#cursor.close"]]],

["cursor.comment()", "Attaches a comment to the query to allow for traceability in the logs and the system.profile collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.comment/#cursor.comment"]]],

["cursor.count()", "Modifies the cursor to return the number of documents in the result set rather than the documents themselves.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.count/#cursor.count"]]],

["cursor.explain()", "Reports on the query execution plan for a cursor.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.explain/#cursor.explain"]]],

["cursor.forEach()", "Applies a JavaScript function for every document in a cursor.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.forEach/#cursor.forEach"]]],

["cursor.hasNext()", "Returns true if the cursor has documents and can be iterated.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.hasNext/#cursor.hasNext"]]],

["cursor.hint()", "Forces MongoDB to use a specific index for a query.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.hint/#cursor.hint"]]],

["cursor.itcount()", "Computes the total number of documents in the cursor client-side by fetching and iterating the result set.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.itcount/#cursor.itcount"]]],

["cursor.limit()", "Constrains the size of a cursor’s result set.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.limit/#cursor.limit"]]],

["cursor.map()", "Applies a function to each document in a cursor and collects the return values in an array.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.map/#cursor.map"]]],

["cursor.maxScan()", "Specifies the maximum number of items to scan; documents for collection scans, keys for index scans.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.maxScan/#cursor.maxScan"]]],

["cursor.maxTimeMS()", "Specifies a cumulative time limit in milliseconds for processing operations on a cursor.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.maxTimeMS/#cursor.maxTimeMS"]]],

["cursor.max()", "Specifies an exclusive upper index bound for a cursor. For use with cursor.hint()", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.max/#cursor.max"]]],

["cursor.min()", "Specifies an inclusive lower index bound for a cursor. For use with cursor.hint()", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.min/#cursor.min"]]],

["cursor.next()", "Returns the next document in a cursor.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.next/#cursor.next"]]],

["cursor.noCursorTimeout()", "Instructs the server to avoid closing a cursor automatically after a period of inactivity.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.noCursorTimeout/#cursor.noCursorTimeout"]]],

["cursor.objsLeftInBatch()", "Returns the number of documents left in the current cursor batch.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.objsLeftInBatch/#cursor.objsLeftInBatch"]]],

["cursor.pretty()", "Configures the cursor to display results in an easy-to-read format.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.pretty/#cursor.pretty"]]],

["cursor.readConcern()", "Specifies a read concern for a find() operation.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.readConcern/#cursor.readConcern"]]],

["cursor.readPref()", "Specifies a read preference to a cursor to control how the client directs queries to a replica set.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/cursor.readPref/#cursor.readPref"]]],
...
["db.cloneCollection()", "Copies data directly between MongoDB instances. Wraps cloneCollection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.cloneCollection/#db.cloneCollection"]]],

["db.cloneDatabase()", "Copies a database from a remote host to the current host. Wraps clone.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.cloneDatabase/#db.cloneDatabase"]]],

["db.commandHelp()", "Returns help information for a database command.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.commandHelp/#db.commandHelp"]]],

["db.copyDatabase()", "Copies a database to another database on the current host. Wraps copydb.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.cloneDatabase/#db.cloneDatabase"]]],

["db.createCollection()", "Creates a new collection. Commonly used to create a capped collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.createCollection/#db.createCollection"]]],

["db.currentOp()", "Reports the current in-progress operations.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.currentOp/#db.currentOp"]]],

["db.dropDatabase()", "Removes the current database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.dropDatabase/#db.dropDatabase"]]],

["db.eval()", "Deprecated. Passes a JavaScript function to the mongod instance for server-side JavaScript evaluation.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.eval/#db.eval"]]],

["db.fsyncLock()", "Flushes writes to disk and locks the database to prevent write operations and assist backup operations. Wraps fsync.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.fsyncLock/#db.fsyncLock"]]],

["db.fsyncUnlock()", "Allows writes to continue on a database locked with db.fsyncLock().", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.fsyncUnlock/#db.fsyncUnlock"]]],

["db.getCollection()", "Returns a collection object. Used to access collections with names that are not valid in the mongo shell.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getCollection/#db.getCollection"]]],

["db.getCollectionInfos()", "Returns collection information for all collections in the current database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getCollectionInfos/#db.getCollectionInfos"]]],

["db.getCollectionNames()", "Lists all collections in the current database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getCollectionNames/#db.getCollectionNames"]]],

["db.getLastError()", "Checks and returns the status of the last operation. Wraps getLastError.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getLastError/#db.getLastError"]]],

["db.getLastErrorObj()", "Returns the status document for the last operation. Wraps getLastError.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getLastErrorObj/#db.getLastErrorObj"]]],

["db.getLogComponents()", "Returns the log message verbosity levels.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getLogComponents/#db.getLogComponents"]]],

["db.getMongo()", "Returns the Mongo() connection object for the current connection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getMongo/#db.getMongo"]]],

["db.getName()", "Returns the name of the current database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getName/#db.getName"]]],

["db.getPrevError()", "Returns a status document containing all errors since the last error reset. Wraps getPrevError.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getPrevError/#db.getPrevError"]]],

["db.getProfilingLevel()", "Returns the current profiling level for database operations.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getProfilingLevel/#db.getProfilingLevel"]]],

["db.getProfilingStatus()", "Returns a document that reflects the current profiling level and the profiling threshold.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getProfilingStatus/#db.getProfilingStatus"]]],

["db.getReplicationInfo()", "Returns a document with replication statistics.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getReplicationInfo/#db.getReplicationInfo"]]],

["db.getSiblingDB()", "Provides access to the specified database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getSiblingDB/#db.getSiblingDB"]]],

["db.help()", "Displays descriptions of common db object methods.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.help/#db.help"]]],

["db.hostInfo()", "Returns a document with information about the system MongoDB runs on. Wraps hostInfo", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.hostInfo/#db.hostInfo"]]],

["db.isMaster()", "Returns a document that reports the state of the replica set.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.isMaster/#db.isMaster"]]],

["db.killOp()", "Terminates a specified operation.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.killOp/#db.killOp"]]],

["db.listCommands()", "Displays a list of common database commands.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.listCommands/#db.listCommands"]]],

["db.loadServerScripts()", "Loads all scripts in the system.js collection for the current database into the shell session.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.loadServerScripts/#db.loadServerScripts"]]],

["db.logout()", "Ends an authenticated session.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.logout/#db.logout"]]],

["db.printCollectionStats()", "Prints statistics from every collection. Wraps db.collection.stats().", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.printCollectionStats/#db.printCollectionStats"]]],

["db.printReplicationInfo()", "Prints a report of the status of the replica set from the perspective of the primary.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.printReplicationInfo/#db.printReplicationInfo"]]],

["db.printShardingStatus()", "Prints a report of the sharding configuration and the chunk ranges.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.printShardingStatus/#db.printShardingStatus"]]],

["db.printSlaveReplicationInfo()", "Prints a report of the status of the replica set from the perspective of the secondaries.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.printSlaveReplicationInfo/#db.printSlaveReplicationInfo"]]],

["db.repairDatabase()", "Runs a repair routine on the current database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.repairDatabase/#db.repairDatabase"]]],

["db.resetError()", "Resets the error message returned by db.getPrevError() and getPrevError.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.resetError/#db.resetError"]]],

["db.runCommand()", "Runs a database command.", [["MongoDB", "mongo Shell Methods", ""]]],

["db.serverBuildInfo()", "Returns a document that displays the compilation parameters for the mongod instance. Wraps buildinfo.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.serverBuildInfo/#db.serverBuildInfo"]]],

["db.serverCmdLineOpts()", "Returns a document with information about the runtime used to start the MongoDB instance. Wraps getCmdLineOpts.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.serverCmdLineOpts/#db.serverCmdLineOpts"]]],

["db.serverStatus()", "Returns a document that provides an overview of the state of the database process.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.serverStatus/#db.serverStatus"]]],

["db.setLogLevel()", "Sets a single log message verbosity level.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.setLogLevel/#db.setLogLevel"]]],

["db.setProfilingLevel()", "Modifies the current level of database profiling.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.setProfilingLevel/#db.setProfilingLevel"]]],

["db.shutdownServer()", "Shuts down the current mongod or mongos process cleanly and safely.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.shutdownServer/#db.shutdownServer"]]],

["db.stats()", "Returns a document that reports on the state of the current database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.stats/#db.stats"]]],

["db.version()", "Returns the version of the mongod instance.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.version/#db.version"]]],

["db.upgradeCheck()", "Performs a preliminary check for upgrade preparedness for a specific database or collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.upgradeCheck/#db.upgradeCheck"]]],

["db.upgradeCheckAllDBs()", "Performs a preliminary check for upgrade preparedness for all databases and collections.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.upgradeCheckAllDBs/#db.upgradeCheckAllDBs"]]]

["cat()", "Returns the contents of the specified file.", [["", "", ""]]],

["version()", "Returns the current version of the mongo shell instance.", [["", "", ""]]],

["cd()", "Changes the current working directory to the specified path.", [["MongoDB", "mongo Shell Methods", ""]]],

["sleep()", "Suspends the mongo shell for a given period of time.", [["", "", ""]]],

["copyDbpath()", "Copies a local dbPath. For internal use.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/copyDbpath/#copyDbpath"]]],

["resetDbpath()", "Removes a local dbPath. For internal use.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/resetDbpath/#resetDbpath"]]],

["fuzzFile()", "For internal use to support testing.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/fuzzFile/#fuzzFile"]]],

["getHostName()", "Returns the hostname of the system running the mongo shell.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/getHostName/#getHostName"]]],

["getMemInfo()", "Returns a document that reports the amount of memory used by the shell.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/getMemInfo/#getMemInfo"]]],

["hostname()", "Returns the hostname of the system running the shell.", [["", "", ""]]],

["_isWindows()", "Returns true if the shell runs on a Windows system; false if a Unix or Linux system.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/isWindows/#_isWindows"]]],

["listFiles()", "Returns an array of documents that give the name and size of each object in the directory.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/listFiles/#listFiles"]]],

["load()", "Loads and runs a JavaScript file in the shell.", [["", "", ""]]],

["ls()", "Returns a list of the files in the current directory.", [["", "", ""]]],

["md5sumFile()", "The md5 hash of the specified file.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/md5sumFile/#md5sumFile"]]],
...
["_rand()", "Returns a random number between 0 and 1.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rand/#_rand"]]],

["removeFile()", "Removes the specified file from the local file system.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/removeFile/#removeFile"]]],

["setVerboseShell()", "Configures the mongo shell to report operation timing.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/setVerboseShell/#setVerboseShell"]]],

["_srand()", "For internal use.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/srand/#_srand"]]]
...
["rs.add()", "Adds a member to a replica set.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.add/#rs.add"]]],

["rs.addArb()", "Adds an arbiter to a replica set.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.addArb/#rs.addArb"]]],

["rs.conf()", "Returns the replica set configuration document.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.conf/#rs.conf"]]],

["rs.freeze()", "Prevents the current member from seeking election as primary for a period of time.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.freeze/#rs.freeze"]]],

["rs.help()", "Returns basic help text for replica set functions.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.help/#rs.help"]]],

["rs.initiate()", "Initializes a new replica set.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.initiate/#rs.initiate"]]],

["rs.printReplicationInfo()", "Prints a report of the status of the replica set from the perspective of the primary.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.printSlaveReplicationInfo/#rs.printSlaveReplicationInfo"]]],

["rs.printSlaveReplicationInfo()", "Prints a report of the status of the replica set from the perspective of the secondaries.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.printSlaveReplicationInfo/#rs.printSlaveReplicationInfo"]]],

["rs.reconfig()", "Re-configures a replica set by applying a new replica set configuration object.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.reconfig/#rs.reconfig"]]],

["rs.remove()", "Remove a member from a replica set.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.remove/#rs.remove"]]],

["rs.slaveOk()	Sets the slaveOk property for the current connection. Deprecated. Use readPref() and Mongo.setReadPref()", "to set read preference.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.slaveOk/#rs.slaveOk"]]],

["rs.status()", "Returns a document with information about the state of the replica set.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.status/#rs.status"]]],

["rs.stepDown()", "Causes the current primary to become a secondary which forces an election.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.stepDown/#rs.stepDown"]]],

["rs.syncFrom()", "Sets the member that this replica set member will sync from, overriding the default sync target selection logic.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/rs.syncFrom/#rs.syncFrom"]]]

["db.createRole()", "Creates a role and specifies its privileges.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.createRole/#db.createRole"]]],

["db.updateRole()", "Updates a user-defined role.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.updateRole/#db.updateRole"]]],

["db.dropRole()", "Deletes a user-defined role.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.dropRole/#db.dropRole"]]],

["db.dropAllRoles()", "Deletes all user-defined roles associated with a database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.dropAllRoles/#db.dropAllRoles"]]],

["db.grantPrivilegesToRole()", "Assigns privileges to a user-defined role.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.grantPrivilegesToRole/#db.grantPrivilegesToRole"]]],

["db.revokePrivilegesFromRole()", "Removes the specified privileges from a user-defined role.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.revokePrivilegesFromRole/#db.revokePrivilegesFromRole"]]],

["db.grantRolesToRole()", "Specifies roles from which a user-defined role inherits privileges.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.grantRolesToRole/#db.grantRolesToRole"]]],

["db.revokeRolesFromRole()", "Removes inherited roles from a role.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.revokeRolesFromRole/#db.revokeRolesFromRole"]]],

["db.getRole()", "Returns information for the specified role.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getRole/#db.getRole"]]],

["db.getRoles()", "Returns information for all the user-defined roles in a database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getRoles/#db.getRoles"]]]
...
["sh.getBalancerLockDetails()", "Reports on the active balancer lock, if it exists.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.getBalancerLockDetails/#sh.getBalancerLockDetails"]]],

["sh._checkFullName()", "Tests a namespace to determine if its well formed.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh._checkFullName/#sh._checkFullName"]]],

["sh._checkMongos()", "Tests to see if the mongo shell is connected to a mongos instance.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh._checkMongos/#sh._checkMongos"]]],

["sh._lastMigration()", "Reports on the last chunk migration.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh._lastMigration/#sh._lastMigration"]]],

["sh.addShard()", "Adds a shard to a sharded cluster.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.addShard/#sh.addShard"]]],

["sh.addShardTag()", "Associates a shard with a tag, to support tag aware sharding.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.addShardTag/#sh.addShardTag"]]],

["sh.addTagRange()", "Associates range of shard keys with a shard tag, to support tag aware sharding.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.addTagRange/#sh.addTagRange"]]],

["sh.removeTagRange()", "Removes an association between a range shard keys and a shard tag. Use to manage tag aware sharding.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.removeTagRange/#sh.removeTagRange"]]],

["sh.disableBalancing()", "Disable balancing on a single collection in a sharded database. Does not affect balancing of other collections in a sharded cluster.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.disableBalancing/#sh.disableBalancing"]]],

["sh.enableBalancing()	Activates the sharded collection balancer process if previously disabled using sh.disableBalancing()", "", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.enableBalancing/#sh.enableBalancing"]]],

["sh.enableSharding()", "Enables sharding on a specific database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.enableSharding/#sh.enableSharding"]]],

["sh.getBalancerHost()", "Returns the name of a mongos that’s responsible for the balancer process.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.getBalancerHost/#sh.getBalancerHost"]]],

["sh.getBalancerState()", "Returns a boolean to report if the balancer is currently enabled.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.getBalancerState/#sh.getBalancerState"]]],

["sh.help()", "Returns help text for the sh methods.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.help/#sh.help"]]],

["sh.isBalancerRunning()", "Returns a boolean to report if the balancer process is currently migrating chunks.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.isBalancerRunning/#sh.isBalancerRunning"]]],

["sh.moveChunk()", "Migrates a chunk in a sharded cluster.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.moveChunk/#sh.moveChunk"]]],

["sh.removeShardTag()", "Removes the association between a shard and a shard tag.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.removeShardTag/#sh.removeShardTag"]]],

["sh.setBalancerState()", "Enables or disables the balancer which migrates chunks between shards.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.setBalancerState/#sh.setBalancerState"]]],

["sh.shardCollection()", "Enables sharding for a collection.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.shardCollection/#sh.shardCollection"]]],

["sh.splitAt()", "Divides an existing chunk into two chunks using a specific value of the shard key as the dividing point.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.splitAt/#sh.splitAt"]]],

["sh.splitFind()", "Divides an existing chunk that contains a document matching a query into two approximately equal chunks.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.splitFind/#sh.splitFind"]]],

["sh.startBalancer()", "Enables the balancer and waits for balancing to start.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.startBalancer/#sh.startBalancer"]]],

["sh.status()	Reports on the status of a sharded cluster, as db.printShardingStatus()", "", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.status/#sh.status"]]],

["sh.stopBalancer()", "Disables the balancer and waits for any in progress balancing rounds to complete.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.stopBalancer/#sh.stopBalancer"]]],

["sh.waitForBalancer()", "Internal. Waits for the balancer state to change.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.waitForBalancer/#sh.waitForBalancer"]]],

["sh.waitForBalancerOff()", "Internal. Waits until the balancer stops running.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.waitForBalancerOff/#sh.waitForBalancerOff"]]],

["sh.waitForDLock()", "Internal. Waits for a specified distributed sharded cluster lock.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.waitForDLock/#sh.waitForDLock"]]],

["sh.waitForPingChange()", "Internal. Waits for a change in ping state from one of the mongos in the sharded cluster.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/sh.waitForPingChange/#sh.waitForPingChange"]]]

["db.auth()", "Authenticates a user to a database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.auth/#db.auth"]]],

["db.createUser()", "Creates a new user.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.createUser/#db.createUser"]]],

["db.updateUser()", "Updates user data.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.updateUser/#db.updateUser"]]],

["db.changeUserPassword()", "Changes an existing user’s password.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.changeUserPassword/#db.changeUserPassword"]]],

["db.removeUser()", "Deprecated. Removes a user from a database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.removeUser/#db.removeUser"]]],

["db.dropAllUsers()", "Deletes all users associated with a database.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.dropAllUsers/#db.dropAllUsers"]]],

["db.dropUser()", "Removes a single user.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.dropUser/#db.dropUser"]]],

["db.grantRolesToUser()", "Grants a role and its privileges to a user.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.grantRolesToUser/#db.grantRolesToUser"]]],

["db.revokeRolesFromUser()", "Removes a role from a user.", [["MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.revokeRolesFromUser/#db.revokeRolesFromUser"]]],
...
["db.getUsers()", "Returns information about all users associated with a database.", [["MongoDB", "mongo Shell Methods", "MongoDB", "mongo Shell Methods", "https://docs.mongodb.org/manual/reference/method/db.getUsers/#db.getUsers"]]]
...
["$each", "Modifies the $push and $addToSet operators to append multiple items for array updates.", [["MongoDB", "Update Operator Modifiers", "https://docs.mongodb.org/v3.0/reference/operator/update/each/#up._S_each"]]],

["$slice", "Modifies the $push operator to limit the size of updated arrays.", [["MongoDB", "Update Operator Modifiers", "https://docs.mongodb.org/v3.0/reference/operator/update/slice/#up._S_slice"]]],

["$sort", "Modifies the $push operator to reorder documents stored in an array.", [["MongoDB", "Update Operator Modifiers", "https://docs.mongodb.org/v3.0/reference/operator/update/sort/#up._S_sort"]]],

["$position", "Modifies the $push operator to specify the position in the array to add elements.", [["MongoDB", "Update Operator Modifiers", "https://docs.mongodb.org/v3.0/reference/operator/update/position/#up._S_position"]]]